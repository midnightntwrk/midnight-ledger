...
describe('Ledger API - DustLocalState', () => {
  ...
  test('should set the generation info dtime correctly', () => {
    ...
    const overallCost = Math.max(normalizedCost.readTime, normalizedCost.computeTime, normalizedCost.blockUsage, normalizedCost.bytesWritten, normalizedCost.bytesChurned);
