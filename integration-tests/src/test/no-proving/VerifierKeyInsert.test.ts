...
import { ContractOperationVersionedVerifierKey, VerifierKeyInsert } from '@midnightntwrk/ledger';
...
describe('Ledger API - VerifierKeyInsert', () => {
  ...
  test('should construct with operation and verifier key', () => {
    ...
    const verifierKey = new ContractOperationVersionedVerifierKey('v4', TestResource.operationVerifierKey());
