...
export class ProofMarker {
  static readonly proof: Proof['instance'] = 'proof';
  static readonly preProof: PreProof['instance'] = 'pre-proof';
  static readonly noProof: NoProof['instance'] = 'no-proof';
}

export class BindingMarker {
