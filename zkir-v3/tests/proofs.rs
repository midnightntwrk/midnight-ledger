...
mod proof_tests {
    ...
    async fn test_bytes_conversion_proof() {
        // Exercises to_bytes / from_bytes across all supported types
        // (Native, Secp256k1Base, Secp256k1Scalar with 32 bytes, and
        // Curve25519Scalar with 64 bytes):
        //   1. Round-trips a typed value through to_bytes then
        //      from_bytes and checks it matches the original.
        //   2. Converts a fixed, non-canonical byte string (all 0xff,
        ...
        use midnight_zkir_v3::ir_instructions::from_bytes::from_bytes_offcircuit;
